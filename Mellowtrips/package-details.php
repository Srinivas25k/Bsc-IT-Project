...
$status=0;
$sql="INSERT INTO tblbooking(PackageId,UserEmail,FromDate,status) VALUES(:pkgid,:useremail,:fromdate,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':pkgid',$PackageId,PDO::PARAM_STR);
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<div class="grand">
					<p>Grand Total</p>
					<h3><?php echo htmlentities($result->PackagePrice);?> INR</h3>
				</div>
			</div>
		...
		<div class="selectroom_top">
			<div class="selectroom-info animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp; margin-top: -70px">
				<ul>
					...
					<a href="Receipt.php" class="btn-secondary btn"> Receipt </a>
						</li>
						<?php } else {?>
