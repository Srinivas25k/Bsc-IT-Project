...
$sql="INSERT INTO TblTourPackages(PackageName,PackageType,PackageLocation,PackagePrice,PackageFetures,PackageDetails,PackageImage,persons,Duration,Pickup,hotel) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage,:persons,:Duration,:Pickup,:Hotel)";
...
$query->bindParam(':Pickup',$Pick-up-point,PDO::PARAM_STR);
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Persons</label>
									<div class="col-sm-8">
									<textarea class="form-control" rows="5" cols="50" name="persons" id="persons" placeholder="No. of persons" required></textarea> 
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="Duration" id="Duration" placeholder=" Duration" required>
									</div>
								</div>
	<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Pick Up point</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="Pickup" id="Pickup" placeholder=" Pick Up Point" required>
									</div>
								</div>
	<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Hotel</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="hotel" id="hotel" placeholder=" Hotel " required>
									</div>
								</div>
